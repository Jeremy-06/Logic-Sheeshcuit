...
Public Class capacitors
    ...
    Private Sub minus_btn_Click_1(sender As Object, e As EventArgs) Handles minus_btn.Click
        If product28Qty > 0 Then
            product28Qty -= 1
            TextBox1.Text = product28Qty.ToString()
            If product28Qty <= 0 Then minus_btn.Enabled = False
        End If
    End Sub
    ...
    Private Sub minus_btn1_Click_1(sender As Object, e As EventArgs) Handles minus_btn1.Click
        If product29Qty > 0 Then
            product29Qty -= 1
            TextBox2.Text = product29Qty.ToString()
            If product29Qty <= 0 Then minus_btn1.Enabled = False
        End If
    End Sub
    ...
    Private Sub minus_btn2_Click_1(sender As Object, e As EventArgs) Handles minus_btn2.Click
        If product30Qty > 0 Then
            product30Qty -= 1
            TextBox3.Text = product30Qty.ToString()
            If product30Qty <= 0 Then minus_btn2.Enabled = False
        End If
    End Sub
    ...
    Private Sub minus_btn3_Click_1(sender As Object, e As EventArgs) Handles minus_btn3.Click
        If product31Qty > 0 Then
            product31Qty -= 1
            TextBox4.Text = product31Qty.ToString()
            If product31Qty <= 0 Then minus_btn3.Enabled = False
        End If
    End Sub
    ...
    Private Sub minus_btn4_Click_1(sender As Object, e As EventArgs) Handles minus_btn4.Click
        If product32Qty > 0 Then
            product32Qty -= 1
            TextBox5.Text = product32Qty.ToString()
            If product32Qty <= 0 Then minus_btn4.Enabled = False
        End If
    End Sub
    ...
    Private Sub minus_btn5_Click_1(sender As Object, e As EventArgs) Handles minus_btn5.Click
        If product33Qty > 0 Then
            product33Qty -= 1
            TextBox6.Text = product33Qty.ToString()
            If product33Qty <= 0 Then minus_btn5.Enabled = False
        End If
    End Sub
    ...
    Private Sub minus_btn6_Click_1(sender As Object, e As EventArgs) Handles minus_btn6.Click
        If product34Qty > 0 Then
            product34Qty -= 1
            TextBox7.Text = product34Qty.ToString()
            If product34Qty <= 0 Then minus_btn6.Enabled = False
        End If
    End Sub
End Class