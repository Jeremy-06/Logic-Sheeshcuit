...
Public Class resistor
    ...
    Private Sub minus_btn_Click_1(sender As Object, e As EventArgs) Handles minus_btn.Click
        If product22Qty > 0 Then
            product22Qty -= 1
            TextBox1.Text = product22Qty.ToString()
            If product22Qty <= 0 Then minus_btn.Enabled = False
        End If
    End Sub
    ...
    Private Sub minus_btn1_Click_1(sender As Object, e As EventArgs) Handles minus_btn1.Click
        If product23Qty > 0 Then
            product23Qty -= 1
            TextBox2.Text = product23Qty.ToString()
            If product23Qty <= 0 Then minus_btn1.Enabled = False
        End If
    End Sub
    ...
    Private Sub minus_btn2_Click_1(sender As Object, e As EventArgs) Handles minus_btn2.Click
        If product24Qty > 0 Then
            product24Qty -= 1
            TextBox3.Text = product24Qty.ToString()
            If product24Qty <= 0 Then minus_btn2.Enabled = False
        End If
    End Sub
    ...
    Private Sub minus_btn3_Click_1(sender As Object, e As EventArgs) Handles minus_btn3.Click
        If product25Qty > 0 Then
            product25Qty -= 1
            TextBox4.Text = product25Qty.ToString()
            If product25Qty <= 0 Then minus_btn3.Enabled = False
        End If
    End Sub
    ...
    Private Sub minus_btn4_Click_1(sender As Object, e As EventArgs) Handles minus_btn4.Click
        If product26Qty > 0 Then
            product26Qty -= 1
            TextBox5.Text = product26Qty.ToString()
            If product26Qty <= 0 Then minus_btn4.Enabled = False
        End If
    End Sub
    ...
    Private Sub minus_btn5_Click_1(sender As Object, e As EventArgs) Handles minus_btn5.Click
        If product27Qty > 0 Then
            product27Qty -= 1
            TextBox6.Text = product27Qty.ToString()
            If product27Qty <= 0 Then minus_btn5.Enabled = False
        End If
    End Sub
End Class